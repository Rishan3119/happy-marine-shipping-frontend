...
export default function SingleShipCharter() {
  ...
  return (
    <div className="bg-gradient-to-r from-[#2e5775] to-[#326e99]">
      ...
      <button className="text-white" onClick={() => navigate(`/shipreadytochart`)}>
      ...
      <div className="px-10 xm:px-2 lg:block hidden mt-5">
      <button className="text-white" onClick={() => navigate(`/shipreadytochart`)}>
      <i class='bx bx-chevrons-left bx-flashing bx-flip-vertical' ></i> Back
      </button>
        </div>
