                    ...
                    {paginatedGroups.length === 0 ? (
                      <tr>
                        <td colSpan="6" className="text-center py-4">
                          Cargo Ships nots Available
                        </td>
                      </tr>
                    ) : (
                      paginatedGroups.map((ship, index) => (
                        <tr key={index} className="border-b">
                          <td onClick={()=>navigate(`/singleShip/${ship.id}`)} className="px-4 py-2 cursor-pointer text-[#d1a460]  text-center  border-r hover:underline border-white">
                            {ship.title}
                          </td>
